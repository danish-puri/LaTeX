...
\end{center}
%-------------- End of Lecture 1 -----------------
%You can ignore the rest of document. We did not cover text formatting, graphcis,and symbols for limits, and integation in class. Pherhaps, watch the world cup :) 
